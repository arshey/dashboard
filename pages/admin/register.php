              ...
              <div class="card-body table-responsive p-0">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="nom" class="form-control" placeholder="Nom & Prénoms">
                  </div>
                  ...
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <label class="input-group-text" for="secteur"><i class="fa fa-address-card"></i></label>
                    </div>
                    <select class="custom-select" id="secteur">
                      <option selected disabled>Choisir le statut</option>
                      <option disabled value="" selected>Statut</option>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="logo">Choississez une photo</label>
                    </div>
                  </div>
