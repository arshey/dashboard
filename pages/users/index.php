  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Listes des inscrits</h3>
              ...
              <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                      ...
                      <a href="print.php" class="btn btn-success" name="print"><i class="fas fa-print"></i></a>
                    </div>
                </div>
                </form>
              </div>
        ...
        <table class="table table-striped projects">
          ...
          <tbody class="text-center">
            <tr>
              ...
              <td>
                <img alt="Avatar" class="table-avatar" src="../../dist/img/cp1.png">
              </td>
              ...
              <td class="project-actions text-right">
                ...
                <a class="btn btn-info btn-sm" href="sendMessage.php">
